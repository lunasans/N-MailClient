...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        // Unbehandelte Fehler sollen die Anwendung nicht wortlos beenden.
        ...
        // Vor dem Container: die Dienste legen ihre Pfade im Feldinitialisierer
        // fest, ein Umzug danach käme zu spät.
        ...
        // Vorgabesprache auf.
        NMailClient.Services.I18n.Loc.Current.Use(vm.Settings.Language);
        ...
        if (NMailClient.Services.Shell.Autostart.StartedMinimized(e.Args))
        {
