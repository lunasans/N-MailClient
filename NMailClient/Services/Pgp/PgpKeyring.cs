...
namespace NMailClient.Services.Pgp;
...
/// (<c>%APPDATA%\NMailClient\pgp</c>) statt <c>%APPDATA%\gnupg</c>. Grund: das
...
public sealed class PgpKeyring : GnuPGContext
{
    ...
    public static string DefaultDirectory => Path.Combine(AppPaths.Roaming, "pgp");
