...
| **Logging in Datei** statt MessageBox | S | **erledigt** | `AppLog` nach `%LOCALAPPDATA%\NMailClient.Poc\app.log`, 1 MiB Rotation. Bei DI-Einführung hinter `ILogger` ziehen. |
